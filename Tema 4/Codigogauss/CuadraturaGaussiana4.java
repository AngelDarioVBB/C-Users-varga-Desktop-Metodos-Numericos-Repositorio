public class CuadraturaGaussiana4 {
    public static void main(String[] args) {
        ...
        System.out.println("=== Cuadratura Gaussiana: ∫ ln(x+1) dx [0,2] ===");
        System.out.printf("Valor exacto (3ln3-2) = %.15f%n%n", 3 * Math.log(3) - 2);

        for (int n = 2; n <= 5; n++) {
            double resultado = cuadraturaGaussiana(a, b, n);
            System.out.printf("n = %d: %.15f (error: %.2e)%n",
                n, resultado, Math.abs(3 * Math.log(3) - 2 - resultado));
        }
    }
